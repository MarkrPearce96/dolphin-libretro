...
"""
Schema-fidelity check between dolphin-libretro's CoreOptions*.cpp and
RetroNest-Project's DolphinLibretroAdapter::settingsSchema().
...
Usage:
  check_schema_fidelity.py
    --core <glob to CoreOptions*.cpp under dolphin-libretro/>
    --host <path to dolphin_libretro_adapter.cpp under RetroNest-Project/>
